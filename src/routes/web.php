...
//Route::middleware(['auth:sanctum', 'verified'])->get('/logout', [ProfileController::class, 'logout']);
//Route::middleware(['auth:sanctum', 'verified'])->get('/', [ImagesController::class, 'index']);
